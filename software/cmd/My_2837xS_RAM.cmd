...
PAGE 1 :
   ...
   RAMGS7      : origin = 0x013000, length = 0x004000 /* Esta sección se amplio para abarcar las tres siguientes secciones*/
...
SECTIONS
{
   ...
   .sysmem          : > RAMD1, PAGE = 1
   .cinit           : > RAMM0,     PAGE = 0 /*Variables globales y estáticas inicializadas*/
   .pinit           : > RAMM0,     PAGE = 0
   .switch          : > RAMM0,     PAGE = 0 /*Tablas para "switch"*/
   .reset           : > RESET,     PAGE = 0, TYPE = DSECT /* not used, */

   .stack           : > RAMM1,     PAGE = 1  /*Stack*/
   .ebss            : >> RAMGS7 | RAMGS11 | RAMGS12,     PAGE = 1  /*Variables globales y estáticas*/
   .econst          : >> RAMGS11 | RAMGS12,     PAGE = 1 /*Constantes*/
   .esysmem         : > RAMGS12,     PAGE = 1 /*Para memodia dinámica (malloc)*/
